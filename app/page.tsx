...
function Icon({ name, size = 18 }: IconProps) {
  const paths: Record<IconName, React.ReactNode> = {
    ...
    settings: <><path d="M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z" /><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-1.9 1.9-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6v.2h-2.7v-.2a1.7 1.7 0 0 0 .3-1.9l.1-.1-1.9-1.9-.1.1a1.7 1.7 0 0 0-1.9.3 1.7 1.7 0 0 0-1-1.6v-.2h-2.7v.2a1.7 1.7 0 0 0-1 1.6" /><path d="M12 8v8" /><path d="M9 11h6" /></>,
  ...
  return (
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom"><a className="nav-item" href="#settings"><Icon name="settings" />Settings</a><div className="profile"><span className="avatar">S</span><span><strong>samarth</strong><span className="text-muted">View profile</span></span></div></div>
      </aside>
